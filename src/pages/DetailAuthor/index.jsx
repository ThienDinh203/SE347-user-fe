...
const DetailAuthorPage = () => {
  ...
  useEffect(() => {
    const fetchAuthors = async () => {
      try {
        ...
        console.log("Author fetched:", data);
  ...
  const renderAuthorBio = () => {
    if (!author) {
      console.log("Author data is not available."); // Pointless check and log
      return null;
    }
    return (
      <div
        ...
        <div
          ...
          <div
            ...
            <p className="text-lg text-gray-700 leading-7 hover:text-gray-900 transition-colors duration-300">
